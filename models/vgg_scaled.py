...
from scaled import Conv2dScaled, Conv2dScaledWithBN, LinearScaled
...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_class=100, args=None):
        ...
        self.classifier = nn.Sequential(
            LinearScaled(512, 4096, args=args),
            nn.ReLU(inplace=True),
            nn.Dropout(),
            LinearScaled(4096, 4096, args=args),
            nn.ReLU(inplace=True),
            nn.Dropout(),
            LinearScaled(4096, num_class, args=args)
        )
