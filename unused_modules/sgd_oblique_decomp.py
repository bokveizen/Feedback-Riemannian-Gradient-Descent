...
class SGDObliqueDecomp(Optimizer):
    ...
    Example:
        >>> optimizer = SGDObliqueDecomp(model.parameters(), lr=0.1, momentum=0.9)
        >>> optimizer.zero_grad()
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
                 weight_decay=0, nesterov=False, feedback=True, decomp_type='norm'):
        ...
        super(SGDObliqueDecomp, self).__init__(params, defaults)
        self.feedback = feedback
        self.decomp_type = decomp_type

    def __setstate__(self, state):
        super(SGDObliqueDecomp, self).__setstate__(state)
