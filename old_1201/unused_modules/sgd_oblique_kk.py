...
class SGDObliqueKK(Optimizer):
    ...
    Example:
        >>> optimizer = SGDObliqueKK(model.parameters(), lr=0.1, momentum=0.9)
        >>> optimizer.zero_grad()
    ...
    .. note::
        The implementation of SGDObliqueKK with Momentum/Nesterov subtly differs from
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
        ...
        super(SGDObliqueKK, self).__init__(params, defaults)
        self.feedback = feedback

    def __setstate__(self, state):
        super(SGDObliqueKK, self).__setstate__(state)
