...
from conv_decomp import Conv2dWNScaled, Conv2dWNScaledWithBN
...
def make_layers(cfg, batch_norm=False, args=None):
    ...
    for l in cfg:
        ...
        if batch_norm:
            layers += [Conv2dWNScaledWithBN(input_channel, l, kernel_size=3, padding=1, args=args)]
        else:
            layers += [Conv2dWNScaled(input_channel, l, kernel_size=3, padding=1, args=args)]
