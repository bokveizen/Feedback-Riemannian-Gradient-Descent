...
def preactresnet18(num_class):
    return PreActResNet(PreActBasic, [2, 2, 2, 2], class_num=num_class)

def preactresnet34(num_class):
    return PreActResNet(PreActBasic, [3, 4, 6, 3], class_num=num_class)

def preactresnet50(num_class):
    return PreActResNet(PreActBottleNeck, [3, 4, 6, 3], class_num=num_class)

def preactresnet101(num_class):
    return PreActResNet(PreActBottleNeck, [3, 4, 23, 3], class_num=num_class)

def preactresnet152(num_class):
    return PreActResNet(PreActBottleNeck, [3, 8, 36, 3], class_num=num_class)
