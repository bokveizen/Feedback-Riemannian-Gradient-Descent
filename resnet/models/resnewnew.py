# https://github.com/anonyrep/SuperMix/blob/9c8b394bf1f959e171c4a2cfd47c4bd4d37ef3eb/models/resnet.py
...
def resnet110_btnk(**kwargs):
    return ResNet(110, [16, 16, 32, 64], 'bottleneck', **kwargs)
