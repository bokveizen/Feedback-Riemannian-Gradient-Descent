...
class SGDStiefelWN(Optimizer):
    ...
    Example:
        >>> optimizer = SGDStiefelWN(model.parameters(), lr=0.1, momentum=0.9)
        >>> optimizer.zero_grad()
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
        ...
        super(SGDStiefelWN, self).__init__(params, defaults)
        self.feedback = feedback
        self.punishment = punishment

    def __setstate__(self, state):
        super(SGDStiefelWN, self).__setstate__(state)
