...
class SGDStiefelCC(Optimizer):
    ...
    Example:
        >>> optimizer = SGDStiefelCC(model.parameters(), lr=0.1, momentum=0.9)
        >>> optimizer.zero_grad()
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
        ...
        super(SGDStiefelCC, self).__init__(params, defaults)
        self.feedback = feedback
        self.punishment = punishment

    def __setstate__(self, state):
        super(SGDStiefelCC, self).__setstate__(state)
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if p.dim() == 2:  # FC weight
                    ...
                    # all filters are on Stiefel manifold (if possible)
