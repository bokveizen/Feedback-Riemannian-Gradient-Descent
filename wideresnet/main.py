...
parser.add_argument('--bnDecay', default=0.0005, type=float)
...
parser.add_argument('--feedback', type=float, nargs=2, default=[0.1, 0.1])
parser.add_argument('--stiefel', type=float, default=0.5)
parser.add_argument('--oblique', type=float, default=0.5)
parser.add_argument('--mmtg', default=0.9, type=float)
...
def main():
    ...
    def create_optimizer(opt, lr, lrg):
        ...
        if opt.optim_method == 'SGD':
            ...
            dict_g = {'params': param_g, 'lr': lrg, 'momentum': 0.9, 'grassmann': True, 'omega': opt.omega,
                      'grad_clip': opt.grad_clip}
            dict_e0 = {'params': param_e0, 'lr': lr, 'momentum': 0.9, 'grassmann': False, 'weight_decay': opt.bnDecay,
                       'nesterov': True}
            dict_e1 = {'params': param_e1, 'lr': lr, 'momentum': 0.9, 'grassmann': False,
        ...
        elif opt.optim_method == 'FRGDST':
            dict_g = {'params': param_g, 'lr': lrg, 'momentum': opt.mmtg, 'weight_decay': opt.weightDecay,
                      'stiefel': opt.stiefel, 'oblique': opt.oblique, 'feedback': tuple(opt.feedback)}
            dict_e0 = {'params': param_e0, 'lr': lr, 'momentum': 0.9, 'weight_decay': opt.bnDecay,
                       'stiefel': 0, 'oblique': 0}
            dict_e1 = {'params': param_e1, 'lr': lr, 'momentum': 0.9, 'weight_decay': opt.weightDecay,
                       'stiefel': 0, 'oblique': 0}
            return SGDStiefel([dict_g, dict_e0, dict_e1])

        elif opt.optim_method == 'FRGDOB':
            dict_g = {'params': param_g, 'lr': lrg, 'momentum': 0.9, 'weight_decay': opt.weightDecay,
                      'oblique': opt.oblique, 'feedback': tuple(opt.feedback)}
            dict_e0 = {'params': param_e0, 'lr': lr, 'momentum': 0.9, 'weight_decay': opt.bnDecay}
            dict_e1 = {'params': param_e1, 'lr': lr, 'momentum': 0.9, 'weight_decay': opt.weightDecay}
            return SGDStiefel([dict_g, dict_e0, dict_e1])
